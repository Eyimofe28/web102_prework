...
/************************************************************************************
 * Challenge Bonus 1: Create a navigation menu for easier page movement and access
 **************************************************************************************/

// Get the scroll button and menu options
const scrollButton = document.getElementById("scrollButton");
const menuOptions = document.getElementById("scrollMenu");
...
// Smooth scroll to sections when a menu item is clicked
const menuItems = document.querySelectorAll(".menu-options a");
...
menuItems.forEach(item => {
    item.addEventListener("click", (e) => {
        ...
        window.scrollTo({
            top: targetElement.offsetTop - headerHeight - 25, // Subtract the header height to account for the fixed header
            behavior: "smooth"
        });
